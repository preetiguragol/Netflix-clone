...
const MovieCard:React.FC<MovieCardProps>=({data})=>{
    ...
    return (
        ...
        <div className="opacity-0 absolute top-0 transition duration-200 z-10 invisible sm:visible delay-300 w-full scale-0 group-hover:scale-110 group-hover:-transalte-y-[6vw] group-hover:translate-x-[2vw] group-hover:opacity-100">
